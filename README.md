...
Для запуска приложения нужно скачать папку Backend, запустить в терминале в этой папке команду npm i, затем  npm run watch и не закрывая терминал перейти на страницу https://ekkaterinka.github.io/React_redux_toolkit_saga_online_shoe_store
...
На всех страницах в шапке присутствует виджет поиск.
